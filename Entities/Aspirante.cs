...
namespace WebApiKalum.Entities
{
    public class Aspirante // : IValidatableObject
    {
        ...
        [StringLength(12,MinimumLength = 12, ErrorMessage = "El campo de numero de Expediente debe ser de 12 caracteres")]
        [NoExpediente]
        ...
        /*public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            if(!string.IsNullOrEmpty(NoExpediente))
            {
                ...
                {
                    yield return new ValidationResult("El numero de expediente es inválido, no contiene un -  ", new string[]{nameof(NoExpediente)});
                } else 
                {
